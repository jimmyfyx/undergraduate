...
class LidarProcessing:
    ...
    def construct_birds_eye_view(self, data):
        ...
        # Getting sensor reading from front left
        ...
        # Getting sensor reading from front right
        ...
        # Getting sensor reading from rear left
        ...
        # Getting sensor reading from rear right
