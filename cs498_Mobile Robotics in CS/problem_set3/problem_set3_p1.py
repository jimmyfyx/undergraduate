...
class problem_set3:
    ...
    def estimated_states(self):
        ...
        xdot = self.xhat[1,0]
        vdot = self.a_ # estimated acceleration
        self.xhat[0,0] = self.xhat[0,0] + xdot * self.dt # estimated position
        self.xhat[1,0] = self.xhat[1,0] + vdot * self.dt # estimated velocity
