...
class OdometryNode(Node):
    ...
    latitude = 0.0
    longitude = 0.0
    latitude_0 = 40.07217788696289
    longitude_0 = -88.20980072021484
    ...
    def callback_latitude(self, msg):
        ...
        # print("latitude: {lat}".format(lat=self.latitude))
    
    def callback_longitude(self, msg):
        self.longitude = msg.data
        # print("longitude: {lon}".format(lon=self.longitude))
    ...
    def timer_callback_odom(self):
        ...
        dt = 0.1 #self.current_time - self.last_time # DeltaT
        ...
        self.x, self.y = lonlat2xyz(self.latitude, self.longitude, self.latitude_0, self.longitude_0)       # ...Position
